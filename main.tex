...
\begin{lydelse}
  ...
  \switchcolumn*
    ...
    \item \emph{Talman, vice talman och ledamot i valberedningen får dessutom ej inneha post i kommitté eller nämnd.} \label{4.x:valbar.ober}
    ...
    \item \emph{Revisor ska vara myndig.}
...
\switchcolumn
  ...
  \switchcolumn
    ...
    \item \emph{En högre instans enligt \S\S\ref{4.2:ansvar1}--\ref{4.2:ansvar2} kan förklara att en sektionsaktiv inte har dess förtroende.}
...
% firma teckn
% \item Sektionsordförande \emph{och} sektionskassör tecknar sektionens firma var för sig.
